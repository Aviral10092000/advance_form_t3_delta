...
<body background="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRCt9VX_xWVnrn6bey6Cttg_Z3XboCwGtIr-H_weI1R3SyVv0Gy0w">
	<center><form id='data' name='data' method="post" action="process_form_check.php"><div id='title' class="title"><table><tr><td>Form Title :</td><td><input type="text" name="Title"></td></tr><br><tr><td>Form Description :</td><td><input type="text" name="Description"></td></tr><tr><td>Name:</td><td><input type="text"></td></tr><tr><td>Email : </td><td><input type="text">(someone@abc.com)</td></tr><tr><td>Fix number of submission :</td><td><input type="text" name="Submission"></td></tr><tr><td>Due date:</td><td><input type="text" name="due_Date" onchange ="validateDate(this)">(dd/mm/yyyy)</td></tr></table></div><div id='Q1'><table class="data"><tr><td><textarea id='Q1_T' name='Q1_T'>Type your Question here</textarea><br><div id='Q1_A'><br><input id='Q1_A1' type="hidden" value='text'><input type="text" id='Q1_A1_T' value="text" name = 'Q1_A1_T'><input type="hidden" id='Q1_d1' value = "Delete Option" onclick="deleteoption(this)"><input type="hidden" id='Q1_o1' value='Add more option' onclick="addoption(this)"></div><button type="button" id='Q1_d' value='button' onclick="delete_question(this)">Delete Question</button></td><td><select  name='Q1_select' onchange="select_option(this)"><option value="Text">Text</option><option value="Select">Select</option><option value="File">File</option><option value="Checkbox">Checkbox</option></select></td></tr></table></div><button id='complete_html' onclick="htmlcode()" type='button'>See Html code</button><br><button type='button' onclick="addquestion(this)">Add question</button><button type='submit'>Submit</button></form></center>
	<script type="text/javascript">
		var tablet_number = 1;
		...
		function addoption(input_type) {
				...
				alert(input_type.parentNode.childElementCount);
